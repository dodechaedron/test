import { ChainId, Token, WtMATIC, } from '@pancakeswap/sdk'
...
const DODE_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0x3c33f420c2dF135BB1d361C4f83254e2756AbF25',
  18,
  'DODE',
  'DODECHAEDRON Token',
  'https://pancakeswap.finance/',
...
export const CAKE = {
  ...
  [ChainId.BSC_TESTNET]: DODE_TESTNET,
}
...
export const bscTestnetTokens = {
  wbnb: WtMATIC[ChainId.BSC_TESTNET],
  shdw: SHDW_TESTNET,
  dode: DODE_TESTNET,
  usdc: USDC_TESTNET,
  syrup: new Token(
    ChainId.BSC_TESTNET,
    '0xcFea295645F35b71296E591060C0F887C8b9fB09',
    18,
    'SYRUP',
    'SyrupBar Token',
    'https://pancakeswap.finance/',
