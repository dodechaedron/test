...
const walletconnect = new WalletConnectConnector({
  rpc: {
    [ChainId.BSC]: 'https://rpc-mumbai.maticvigil.com',
    [ChainId.BSC_TESTNET]: 'https://rpc-mumbai.maticvigil.com',
  },
  qrcode: true,
...
export const connectorsByName = {
  ...
  [ConnectorNames.Blocto]: async () => {
    ...
    return new BloctoConnector({ chainId: ChainId.BSC, rpc: 'https://rpc-mumbai.maticvigil.com' })
  },
